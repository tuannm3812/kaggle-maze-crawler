...
- `notebooks/1_maze_crawler_starter.ipynb`: Kaggle notebook version with setup, simulations, and generated submission files.

Supporting docs:

- `docs/0_coding_standards.md`: project conventions for notebooks, generated artifacts, docs, and git hygiene.
...
4. Upload or import `notebooks/1_maze_crawler_starter.ipynb`.
...
Pilkwang's visual diagrams live in `docs/2_eda_insights.md` so the notebook can stay focused on simulation and submission generation.
